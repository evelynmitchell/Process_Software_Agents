-- Migration 005: Add specialist Design Review agent roles to CHECK constraint
-- Date: 2025-11-14
-- Description: Extends agent_role CHECK constraint to include the 6 specialist review agents
...
-- Updated agent_role CHECK constraint to include specialist Design Review agents:
--   - SecurityReview, PerformanceReview, DataIntegrityReview
--   - MaintainabilityReview, ArchitectureReview, APIDesignReview
