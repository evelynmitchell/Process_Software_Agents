...
**Task:** {plan.requirements.description}
**Project ID:** {plan.project_id or "N/A"}
**Estimated Effort:** {plan.probe_prediction.total_effort_hours:.1f} hours
**Estimated Cost:** ${plan.probe_prediction.total_cost:.2f}
...
"""
    ...
    for i, unit in enumerate(plan.semantic_units, 1):
        md += f"""### SU-{i:03d}: {unit.description}

- **Semantic Complexity:** {unit.semantic_complexity:.1f}
- **Dependencies:** {", ".join(unit.dependencies) if unit.dependencies else "None"}
- **Type:** {unit.unit_type}
"""
        if unit.acceptance_criteria:
            md += f"- **Acceptance Criteria:** {unit.acceptance_criteria}\n"

        md += "\n"

    # Add PROBE-AI prediction
    md += f"""## PROBE-AI Cost Prediction

- **Estimated Latency:** {plan.probe_prediction.estimated_latency_seconds:.1f} seconds
- **Estimated Input Tokens:** {plan.probe_prediction.estimated_input_tokens:,}
- **Estimated Output Tokens:** {plan.probe_prediction.estimated_output_tokens:,}
- **Estimated Total Cost:** ${plan.probe_prediction.total_cost:.2f}
- **Total Effort:** {plan.probe_prediction.total_effort_hours:.1f} hours
- **Confidence:** {plan.probe_prediction.confidence * 100:.0f}%
...
*Generated by Planning Agent v{plan.agent_version} on {plan.created_at}*
"""
...
**Project ID:** {design.project_id or "N/A"}
**Based on Plan:** {design.plan_id}
...
"""
            ...
            if api.error_responses:
                md += f"- **Error Responses:** {', '.join(api.error_responses)}\n"
...
*Generated by Design Agent v{design.agent_version} on {design.created_at}*
"""
