    ...
    return DesignSpecification(
        ...
        component_logic=[
            ComponentLogic(
                ...
                interfaces=[{"method": "login", "parameters": {"email": "str", "password": "str"}}],
        ...
        technology_stack={"language": "Python", "framework": "FastAPI", "database": "PostgreSQL"}
    )
...
class TestSecurityReviewAgentExecute:
    ...
    def test_execute_success(self, mock_call_llm, mock_format_prompt, mock_load_prompt):
        ...
        mock_call_llm.return_value = create_mock_security_response(issues_count=3, suggestions_count=2)
    ...
    @patch.object(SecurityReviewAgent, 'format_prompt')
    @patch.object(SecurityReviewAgent, 'call_llm')
    def test_execute_with_no_issues(self, mock_call_llm, mock_format_prompt, mock_load_prompt):
        ...
        mock_load_prompt.return_value = "Security review prompt template"
        mock_format_prompt.return_value = "Formatted security review prompt"
        mock_call_llm.return_value = create_mock_security_response(issues_count=0, suggestions_count=0)
    ...
    @patch.object(SecurityReviewAgent, 'format_prompt')
    @patch.object(SecurityReviewAgent, 'call_llm')
    def test_execute_formats_design_spec_correctly(self, mock_call_llm, mock_format_prompt, mock_load_prompt):
...
class TestSQLInjectionDetection:
    ...
    @patch.object(SecurityReviewAgent, 'format_prompt')
    @patch.object(SecurityReviewAgent, 'call_llm')
    def test_detect_sql_injection_in_api_contract(self, mock_call_llm, mock_format_prompt, mock_load_prompt):
        ...
        design_spec = DesignSpecification(
            ...
            design_review_checklist=[
                ...
                DesignReviewChecklistItem(category="Test", description="Test item 1 here", validation_criteria="Validate test 1"),
                DesignReviewChecklistItem(category="Test", description="Test item 2 here", validation_criteria="Validate test 2"),
                DesignReviewChecklistItem(category="Test", description="Test item 3 here", validation_criteria="Validate test 3"),
                DesignReviewChecklistItem(category="Test", description="Test item 4 here", validation_criteria="Validate test 4"),
            ],
...
class TestXSSDetection:
    ...
    @patch.object(SecurityReviewAgent, 'format_prompt')
    @patch.object(SecurityReviewAgent, 'call_llm')
    def test_detect_xss_in_api_response(self, mock_call_llm, mock_format_prompt, mock_load_prompt):
...
class TestAuthenticationAuthorization:
    ...
    @patch.object(SecurityReviewAgent, 'format_prompt')
    @patch.object(SecurityReviewAgent, 'call_llm')
    def test_detect_missing_authentication(self, mock_call_llm, mock_format_prompt, mock_load_prompt):
        ...
        auth_issues = [i for i in result["issues_found"] if "Authentication" in i.get("title", "")]
        assert len(auth_issues) > 0

    @patch.object(SecurityReviewAgent, 'load_prompt')
    @patch.object(SecurityReviewAgent, 'format_prompt')
    @patch.object(SecurityReviewAgent, 'call_llm')
    def test_detect_weak_password_storage(self, mock_call_llm, mock_format_prompt, mock_load_prompt):
            ...
            data_schemas=[
                DataSchema(
                    ...
                    columns=[
                        ...
                        {"name": "password", "type": "VARCHAR(255)"}  # Not password_hash
                    ]
                )
            ],
            component_logic=[
        ...
        pwd_issues = [i for i in result["issues_found"] if "Password" in i.get("title", "")]
...
class TestSensitiveDataExposure:
    ...
    @patch.object(SecurityReviewAgent, 'format_prompt')
    @patch.object(SecurityReviewAgent, 'call_llm')
    def test_detect_sensitive_data_in_logs(self, mock_call_llm, mock_format_prompt, mock_load_prompt):
        ...
        data_issues = [i for i in result["issues_found"] if "Sensitive Data" in i.get("title", "") or "Data" in i.get("title", "")]
...
class TestSecurityReviewAgentErrorHandling:
    ...
    @patch.object(SecurityReviewAgent, 'format_prompt')
    @patch.object(SecurityReviewAgent, 'call_llm')
    def test_execute_handles_invalid_json_response(self, mock_call_llm, mock_format_prompt, mock_load_prompt):
    ...
    @patch.object(SecurityReviewAgent, 'format_prompt')
    @patch.object(SecurityReviewAgent, 'call_llm')
    def test_execute_handles_missing_issues_found_field(self, mock_call_llm, mock_format_prompt, mock_load_prompt):
    ...
    @patch.object(SecurityReviewAgent, 'format_prompt')
    @patch.object(SecurityReviewAgent, 'call_llm')
    def test_execute_handles_llm_failure(self, mock_call_llm, mock_format_prompt, mock_load_prompt):
...
class TestSecurityReviewAgentEdgeCases:
    ...
    @patch.object(SecurityReviewAgent, 'format_prompt')
    @patch.object(SecurityReviewAgent, 'call_llm')
    def test_execute_with_minimal_design_spec(self, mock_call_llm, mock_format_prompt, mock_load_prompt):
        ...
        design_spec = DesignSpecification(
            ...
            design_review_checklist=[
                DesignReviewChecklistItem(category="Security", description="Check security here", validation_criteria="Validate security", severity="Critical"),
                DesignReviewChecklistItem(category="Test", description="Test item 1 here", validation_criteria="Validate test 1"),
                DesignReviewChecklistItem(category="Test", description="Test item 2 here", validation_criteria="Validate test 2"),
                DesignReviewChecklistItem(category="Test", description="Test item 3 here", validation_criteria="Validate test 3"),
                DesignReviewChecklistItem(category="Test", description="Test item 4 here", validation_criteria="Validate test 4"),
        ...
        mock_load_prompt.return_value = "Prompt"
        mock_format_prompt.return_value = "Formatted"
        mock_call_llm.return_value = create_mock_security_response(issues_count=0, suggestions_count=1)
    ...
    @patch.object(SecurityReviewAgent, 'format_prompt')
    @patch.object(SecurityReviewAgent, 'call_llm')
    def test_execute_with_large_design_spec(self, mock_call_llm, mock_format_prompt, mock_load_prompt):
        ...
        design_spec = DesignSpecification(
            ...
            design_review_checklist=[
                DesignReviewChecklistItem(category="Security", description="Security check here", validation_criteria="Validate security", severity="Critical"),
                DesignReviewChecklistItem(category="Test", description="Test item 1 here", validation_criteria="Validate test 1"),
                DesignReviewChecklistItem(category="Test", description="Test item 2 here", validation_criteria="Validate test 2"),
                DesignReviewChecklistItem(category="Test", description="Test item 3 here", validation_criteria="Validate test 3"),
                DesignReviewChecklistItem(category="Test", description="Test item 4 here", validation_criteria="Validate test 4"),
        ...
        mock_load_prompt.return_value = "Prompt"
        mock_format_prompt.return_value = "Formatted"
        mock_call_llm.return_value = create_mock_security_response(issues_count=10, suggestions_count=5)
