...
- Added cost metrics row showing:
  - API Cost (7 days)
  - Total Tokens
  - Input Tokens
  - Output Tokens

**Developer Stats Page (`/developer/stats`):**
- Added "API Cost Tracking (Last 7 Days)" section:
  - Cost summary cards
...
| `src/asp/web/manager.py` | Added cost tracking display |
| `src/asp/web/developer.py` | Added cost tracking to stats page |
| `docs/web_ui_todo.md` | Created comprehensive todo list, marked 2 tasks complete |
...
- Telemetry DB: `/data/asp_telemetry.db` (currently empty - displays $0.00)

### Status
In progress - 2/13 tasks complete
