...
**Session 3 - Bootstrap Data Collection** ⚠️
...
- Design Agent: 5/12 tasks collected (partial) ⚠️
- Design Review Agent: 5/12 tasks collected (partial) ⚠️
...
#### 1. **Avoid "Debug-by-Rerun" Anti-Pattern** ⚠️
**Problem:**
...
if task_id in existing_results:
    print(f"⏭️ SKIPPING (already successful)")
    continue
```
