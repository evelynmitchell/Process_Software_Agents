...
| File | Purpose | Status |
|------|---------|--------|
| `src/asp/orchestrators/tsp_orchestrator.py` | Add repair mode to TSPOrchestrator | Pending |
| `src/asp/orchestrators/types.py` | Add repair result types | Pending |
| `src/asp/cli/main.py` | Add repair CLI command | Pending |
| `tests/integration/test_repair_workflow.py` | E2E integration tests | Pending |
...
3. Consider Phase 6 (Multi-Language) if time permits
