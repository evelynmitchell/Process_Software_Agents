...
- Changed multi-browser E2E tests to only run on manual trigger (`workflow_dispatch`)
  - Chromium tests still run automatically on push/PR
  - Firefox/WebKit tests available via manual workflow trigger in GitHub Actions
